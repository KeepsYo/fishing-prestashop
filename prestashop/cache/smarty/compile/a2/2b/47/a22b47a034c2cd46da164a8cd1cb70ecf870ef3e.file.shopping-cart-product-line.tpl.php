<?php /* Smarty version Smarty-3.1.19, created on 2015-11-07 08:50:53
         compiled from "D:\Works\Verstka\fishing-prestashop\prestashop\themes\default-bootstrap\shopping-cart-product-line.tpl" */ ?>
<?php /*%%SmartyHeaderCode:30089563d913da66718-12345228%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a22b47a034c2cd46da164a8cd1cb70ecf870ef3e' => 
    array (
      0 => 'D:\\Works\\Verstka\\fishing-prestashop\\prestashop\\themes\\default-bootstrap\\shopping-cart-product-line.tpl',
      1 => 1446128214,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '30089563d913da66718-12345228',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_563d913ddd01b7_83832102',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_563d913ddd01b7_83832102')) {function content_563d913ddd01b7_83832102($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'D:\\Works\\Verstka\\fishing-prestashop\\prestashop\\tools\\smarty\\plugins\\modifier.replace.php';
...
<?php $_tmp46=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add=1&amp;id_product=".$_tmp44."&amp;ipa=".$_tmp45."&amp;id_address_delivery=".$_tmp46."&amp;op=down&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
...
<?php $_tmp49=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add=1&amp;id_product=".$_tmp47."&amp;ipa=".$_tmp48."&amp;id_address_delivery=".$_tmp49."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
...
<?php $_tmp52=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&amp;id_product=".$_tmp50."&amp;ipa=".$_tmp51."&amp;id_address_delivery=".$_tmp52."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
